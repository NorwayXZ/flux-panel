...
public class ServicePublishingSchemaInitializer {
    ...
    public void initialize() {
        try {
            ...
            ensureColumn("internal_connector", "discovery_enabled", "tinyint NOT NULL DEFAULT 0 AFTER last_seen");
            ensureColumn("internal_connector", "discovery_status", "varchar(24) NOT NULL DEFAULT 'disabled' AFTER discovery_enabled");
            ensureColumn("internal_connector", "discovery_last_scan_at", "bigint DEFAULT NULL AFTER discovery_status");
            ensureColumn("internal_connector", "discovery_last_cidr", "varchar(255) DEFAULT NULL AFTER discovery_last_scan_at");
            ensureColumn("internal_connector", "discovery_last_error", "varchar(500) DEFAULT NULL AFTER discovery_last_cidr");
            jdbcTemplate.execute("CREATE TABLE IF NOT EXISTS lan_discovered_service ("
