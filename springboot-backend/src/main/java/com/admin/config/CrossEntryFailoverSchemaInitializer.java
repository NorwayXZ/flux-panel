    ...
    public void initialize() {
        try {
            jdbcTemplate.execute("CREATE TABLE IF NOT EXISTS cross_entry_failover_group ("
                    ...
                    + "traffic_quota_enabled tinyint NOT NULL DEFAULT 0, traffic_quota_limit_bytes bigint NOT NULL DEFAULT 0, "
                    + "traffic_quota_reset_day tinyint NOT NULL DEFAULT 1, traffic_quota_used_bytes bigint NOT NULL DEFAULT 0, "
                    + "traffic_quota_period_start_at bigint DEFAULT NULL, traffic_quota_exhausted tinyint NOT NULL DEFAULT 0, "
                    + "traffic_quota_paused tinyint NOT NULL DEFAULT 0, traffic_quota_exhausted_at bigint DEFAULT NULL, "
                    + "traffic_quota_last_error varchar(500) DEFAULT NULL, created_time bigint NOT NULL, updated_time bigint NOT NULL, PRIMARY KEY (id), "
            ...
            ensureColumn("cross_entry_failover_group", "degraded_fallback_enabled", "tinyint NOT NULL DEFAULT 1 AFTER tcp_primary_preference_tolerance_ms");
            ...
            ensureColumn("cross_entry_failover_member", "topology_signature", "varchar(500) DEFAULT NULL AFTER entry_address");
            ...
            jdbcTemplate.execute("CREATE TABLE IF NOT EXISTS cross_entry_failover_schedule ("
                    ...
                    + "start_minute int NOT NULL,end_minute int NOT NULL,preferred_forward_id bigint NOT NULL,"
                    + "enabled tinyint NOT NULL DEFAULT 1,created_time bigint NOT NULL,updated_time bigint NOT NULL,"
                    + "PRIMARY KEY (id),KEY idx_cross_entry_schedule_group (group_id,enabled),"
