    ...
    public void initialize() {
        try {
            jdbcTemplate.execute("CREATE TABLE IF NOT EXISTS private_proxy ("
                    ...
                    + "node_id bigint NOT NULL, proxy_type varchar(12) NOT NULL, bind_ip varchar(128) NOT NULL DEFAULT '', "
                    ...
                    + "service_name varchar(120) NOT NULL, admission_name varchar(120) DEFAULT NULL, last_error varchar(500) DEFAULT NULL, "
