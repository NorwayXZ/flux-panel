...
export default function DynamicDnsPage() {
  ...
  const saveRule = async () => {
    ...
    if (ruleForm.sourceType === 'connector' && !ruleForm.connectorId) return toast.error('请选择家庭接入端');
    setBusy('rule');
