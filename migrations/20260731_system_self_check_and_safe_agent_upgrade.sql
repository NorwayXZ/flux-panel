...
-- Existing installations receive these columns automatically from
-- AgentUpgradeSchemaInitializer. Keep the statements below for manual migrations.
ALTER TABLE agent_upgrade_task ADD COLUMN batch_id varchar(64) DEFAULT NULL AFTER task_id;
ALTER TABLE agent_upgrade_task ADD COLUMN sequence_no int DEFAULT NULL AFTER batch_id;
ALTER TABLE agent_upgrade_task ADD KEY idx_agent_upgrade_batch (batch_id, sequence_no);
