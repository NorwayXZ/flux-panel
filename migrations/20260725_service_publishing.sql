...
CREATE TABLE IF NOT EXISTS published_service (
...
CREATE TABLE IF NOT EXISTS port_lease_event (
...
CREATE TABLE IF NOT EXISTS service_publish_lock (id int NOT NULL, PRIMARY KEY (id)) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
INSERT IGNORE INTO service_publish_lock (id) VALUES (1);
